...
$x= x, y = y, v_x = \frac{dx}{dt}, v_y = \frac{dy}{dt}$
...
\begin{pmatrix} v_x \\ 
                v_y \\ 
                -G \frac{m_{sun}}{(x^2+y^2)^{3/2}} x\\ 
                -G \frac{m_{sun}}{(x^2+y^2)^{3/2}} y \end{pmatrix}$

where we need to provide 4 initial conditions $x_0, y_0, {v_x}_0, {v_y}_0$.
"""
...
begin
	...
	sol = solve(prob, RK4(), dt = 60*60)
end

# ╔═╡ d33b62f3-31c0-4f3e-9646-dba54e4f91c1
typeof(sol.t)

# ╔═╡ a8dd1f49-d3df-4951-9fd8-e687b9078ba8
length(sol.t)

# ╔═╡ 872e9b57-34c1-4856-9725-80cce0b8edd7
typeof(sol.u[1])

# ╔═╡ a12ecd43-3eeb-4c8d-aad4-64fcf2eae553
length(sol.u[1])

# ╔═╡ 7f8e3b0d-cb83-494e-ab5a-69391f92c07e
begin
	x = 0:0.01:2π
	y = sin.(x)      # note the dot for element-wise operation
...
manifest_format = "2.0"
project_hash = "b9b39d3dc82d349839674eb524b8c14f3e9f7438"
